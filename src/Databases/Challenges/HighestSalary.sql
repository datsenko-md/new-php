...
-- 1	IT
-- 2	Sales
-- Таблица employees содержит всех работников. Каждый работник имеет id и
-- колонку для id подразделения department_id.
--
...
-- 4	Max	90000	1
-- solution.sql
-- Напишите SQL запрос который найдет самые большие зарплаты для каждого
-- департамента.
--
-- name	salary
-- IT	90000
